...
function calcular() {
    ...
    display.value = resultado;
      ...
      var painelDeOperacoes = document.getElementById("operacao");
      var listaDeOperacoes = document.getElementById("lista-operacao");
  
      if(!listaDeOperacoes) {
        listaDeOperacoes = document.createElement("ul");
        listaDeOperacoes.id = "lista-operacao";
        painelDeOperacoes.appendChild(listaDeOperacoes);
      }
      ...
      listaDeOperacoes.appendChild(itemDeAcerto);
      return;
